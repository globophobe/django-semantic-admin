...
$.fn.actions = function(opts) {
  ...
  var showQuestion = function() {
    ...
    checker = function(checked) {
      // BEGIN CUSTOMIZATION //
      if (checked) {
        $(actionCheckboxes).checkbox("check");
        showQuestion();
      } else {
        $(actionCheckboxes).checkbox("uncheck");
        reset();
      }
      // END CUSTOMIZATION //
    },
    updateCounter = function() {
      ...
      // BEGIN CUSTOMIZATION //
      var value;
      var checked = $(options.allToggle).checkbox("is checked");
      if (checked) {
  ...
  $(options.allToggle)
    ...
    .click(function() {
      // BEGIN CUSTOMIZATION //
      checker($(this).checkbox("is checked"));
      // END CUSTOMIZATION //
      updateCounter();
    });
  ...
  $("a", options.acrossClears).click(function(event) {
    event.preventDefault();
    // BEGIN CUSTOMIZATION //
    $(options.allToggle).checkbox("uncheck");
    // END CUSTOMIZATION //
    clearAcross();
    checker(0);
    updateCounter();
...
$(document).ready(function() {
  // BEGIN CUSTOMIZATION //
  var $actionsEls = $(".ui.checkbox.action-select");
  // END CUSTOMIZATION //
